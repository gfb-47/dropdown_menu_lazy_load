...
/// Defines a [DropdownMenuLazyLoad] menu button that represents one item view in the menu.
///
/// See also:
///
/// * [DropdownMenuLazyLoad]
class DropdownMenuEntry<T> {
  /// Creates an entry that is used with [DropdownMenuLazyLoad.dropdownMenuEntries].
  ///
  ...
  ///
  /// This value must be unique across all entries in a [DropdownMenuLazyLoad].
  final T value;
  ...
  /// out in the text field of the [DropdownMenuLazyLoad] when this entry is clicked; otherwise,
...
///
/// {@tool dartpad}
/// This sample shows how to display outlined [DropdownMenuLazyLoad] and filled [DropdownMenuLazyLoad].
///
...
///   The [DropdownMenuLazyLoad] uses a [TextField] as the "anchor".
/// * [TextField], which is a text input widget that uses an [InputDecoration].
/// * [DropdownMenuEntry], which is used to build the [MenuItemButton] in the [DropdownMenuLazyLoad] list.
class DropdownMenuLazyLoad<T> extends StatefulWidget {
  /// Creates a const [DropdownMenuLazyLoad].
  ///
  ...
  /// Determine if the [DropdownMenuLazyLoad] is enabled.
  ///
  /// Defaults to true.
  final bool enabled;

  /// Determine the width of the [DropdownMenuLazyLoad].
  ///
  /// If this is null, the width of the [DropdownMenuLazyLoad] will be the same as the width of the widest
  ...
  /// Text that provides context about the [DropdownMenuLazyLoad]'s value, such
  ...
  /// The text style for the [TextField] of the [DropdownMenuLazyLoad];
  ///
  ...
  /// Descriptions of the menu items in the [DropdownMenuLazyLoad].
  ///
  ...
  @override
  State<DropdownMenuLazyLoad<T>> createState() =>
      _DropdownMenuLazyLoadState<T>();
}

class _DropdownMenuLazyLoadState<T> extends State<DropdownMenuLazyLoad<T>> {
  ...
  @override
  void didUpdateWidget(DropdownMenuLazyLoad<T> oldWidget) {
